...
# System as root
BOARD_ROOT_EXTRA_FOLDERS := cache carrier data_mirror efs linkerconfig odm_dlkm oem optics postinstall prism second_stage_resources spu system_ext vendor_dlkm omr
...
TW_DEVICE_VERSION := 0_hiwlarbzdev
TW_FRAMERATE := 120
